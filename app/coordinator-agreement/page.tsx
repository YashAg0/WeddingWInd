...
export const metadata: Metadata = {
  ...
  description: "Operational guidelines and ground coordinator agreements for Wedding With India liaisons.",
};
        ...
        <div className="bg-white border border-warm-200/50 rounded-[2rem] p-6 sm:p-10 shadow-sm space-y-8 text-charcoal-700 text-sm sm:text-base leading-relaxed">
          <section className="space-y-3">
            <h2 className="font-display font-bold text-lg text-charcoal-900 border-b border-warm-100 pb-2">
              1. Gate Check-In & Guest Support Duties
            </h2>
            <p>
              Ground coordinators represent Wedding With India on site, managing QR pass scanning at event entrances, providing cultural orientation, and acting as emergency safety liaisons.
            </p>
          </section>
        </div>
      </div>
