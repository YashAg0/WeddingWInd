...
export const metadata: Metadata = {
  ...
  description: "Code of conduct and agreement for international traveler guests attending Indian weddings.",
};
        ...
        <div className="bg-white border border-warm-200/50 rounded-[2rem] p-6 sm:p-10 shadow-sm space-y-8 text-charcoal-700 text-sm sm:text-base leading-relaxed">
          <section className="space-y-3">
            <h2 className="font-display font-bold text-lg text-charcoal-900 border-b border-warm-100 pb-2">
              1. Guest Code of Conduct
            </h2>
            <p>
              Travelers agree to respect religious customs, dress code etiquette, and family traditions. Intoxication or disruptive behavior results in immediate gate pass revocation without refund.
            </p>
          </section>
        </div>
      </div>
