...
export const metadata: Metadata = {
  title: "Travel Agent Agreement | Wedding With India",
  description: "Terms and commission structures for travel agents and luxury tour operators on Wedding With India.",
};
        ...
        <div className="bg-white border border-warm-200/50 rounded-[2rem] p-6 sm:p-10 shadow-sm space-y-8 text-charcoal-700 text-sm sm:text-base leading-relaxed">
          <section className="space-y-3">
            <h2 className="font-display font-bold text-lg text-charcoal-900 border-b border-warm-100 pb-2">
              1. Commission Payout Terms
            </h2>
            <p>
              Travel agents earn commission payouts on completed guest bookings referred via unique referral links or agent codes. Commissions are disbursed following successful event gate check-in.
            </p>
          </section>
        </div>
      </div>
