...
| **Search Queries / Min** | 500 / min | 100,000 / min | ElasticSearch / Algolia cluster indexing published listings. |
...
- **Public Listings**: Cached in Redis with a 15-minute Time-To-Live (`TTL=900s`).
...
- **Vector Database**: **Pinecone** / **PgVector** storing 1536-dimensional embeddings of wedding listing descriptions, cultural tradition tags, and venue styles.
