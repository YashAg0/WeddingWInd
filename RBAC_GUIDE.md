...
| **COUPLE** | Wedding Host Couple | Host family celebration weddings, schedules, earnings | `/dashboard/celebrations` |
| **AGENT** | Referral Partner | Freelance agency partner tracking referrals & tiered commission (₹500-₹500)s | `/dashboard/referrals` |
| **COORDINATOR** | On-Site Logistics Lead | City coordinator checking in guests via QR scan | `/dashboard/operations` |
| **ADMIN** | Operations Manager | Platform administrator approving celebrations & applications | `/dashboard/admin` |
...
| `CREATE_WEDDING` | Submit new Indian Indian Wedding Experience | Couple, Super Admin |
...
| `VIEW_HOST_EARNINGS` | Track host revenue (78% share in INR) | Couple, Super Admin |
...
| `REQUEST_COMMISSION_PAYOUT` | Request payout of accrued tiered commission (₹500-₹500)s | Agent, Super Admin |
...
| `VERIFY_HOST_LISTING` | Review and publish pending Our Indian Weddings | Admin, Super Admin |
| `APPROVE_AGENT_APPLICATION` | Review & activate freelance agency partners | Admin, Super Admin |
| `VIEW_ADMIN_FINANCIAL_LEDGER` | Audit 22% platform / 78% host revenue splits | Admin, Super Admin |
...
| `/dashboard/celebrations` | Authenticated | Couple, Super Admin | Yes |
