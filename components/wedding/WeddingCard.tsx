  ...
  return (
    ...
    >
      ...
      <div className="relative h-56 sm:h-60 overflow-hidden">
        ...
        {/* Wishlist button */}
        <button
          className="absolute top-3 right-3 w-8 h-8 rounded-full bg-white/90 backdrop-blur-sm flex items-center justify-center text-charcoal-400 hover:text-[var(--color-brand-primary)] transition-colors shadow-sm"
          aria-label={`Save ${wedding.title} to wishlist`}
        >
