...
async function seedMasterData() {
  ...
  try {
    ...
    const demoWeddingsData = [
      ...
      {
        id: "w22",
        slug: "fd-fd-1786124017875",
        title: "Ahmedabad Heritage Pol Haveli Wedding",
        description: "A breathtaking Gujarati heritage wedding in the UNESCO World Heritage city of Ahmedabad, featuring traditional Garba dances, silver thali feasts, and sacred Phera rituals in a 200-year-old restored Pol haveli.",
        ...
        hostAvatar: "https://images.unsplash.com/photo-1544717305-2782549b5136?w=400&q=80",
        theme: "Gujarati Heritage & Raas Garba",
        dressCode: "Chaniya Choli / Bandhani Kurta & Kedia",
        ethnicity: "Gujarati Hindu",
        traditions: [
          { name: "Raas Garba Night", description: "All-night high-energy Gujarati folk dance celebration with dandiya sticks." },
          { name: "Pokhran & Kanyadaan", description: "Traditional welcoming of the groom followed by solemn Kanyadaan." },
        ],
      },
    ];
