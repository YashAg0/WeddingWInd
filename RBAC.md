...
- **COUPLE**: Verified wedding host. Celebration creation, event timeline editing, guest request approvals, 78% earnings.
- **AGENT**: Verified referral partner. Referral link tracking (`WWI-AGENT-XXXX`), click metrics, tiered accrued commissions (₹500-₹500).
