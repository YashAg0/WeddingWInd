...
export const PRICING_CONSTANTS = {
  ...
  PLATFORM_FEES_PERCENT: BUSINESS_METRICS.PLATFORM_FEE_PERCENT, // 22%
  HOST_ALLOCATION_PERCENT: BUSINESS_METRICS.HOST_ALLOCATION_PERCENT // 78%
};

export const COMMISSION_CONSTANTS = {
  AGENT_REFERRAL_AVERAGE: BUSINESS_METRICS.AGENT_COMMISSION_AVERAGE, // 1000
